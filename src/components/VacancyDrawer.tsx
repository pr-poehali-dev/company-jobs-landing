  ...
  return (
    <>
      ...
      <div className="px-8 py-5 border-t border-brand-gray bg-white sticky bottom-0">
        <div className="flex items-start gap-3 bg-blue-50 border-l-4 border-brand-blue px-4 py-3 mb-4">
          <Icon name="Info" size={16} className="text-brand-blue shrink-0 mt-0.5" />
          <p className="text-xs leading-relaxed" style={{ color: "rgb(0,80,140)" }}>
